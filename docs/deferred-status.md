...
| 12 七日菜单 | feat/deferred-menu-planner | 已合并 PR #41 | 独立 CP-SAT、可追溯营养/用户价格、硬约束、库存不重复占用、保存/复刻/采购；家庭烹饪扣减待组合联调 |
| 13 长期学习 | feat/deferred-personalization | 本地通过，提交云端检查 | 主动开启、明确反馈、时间划分逻辑回归、原排序对照、合格候选内重排、关闭/清除/重置；长期真实收益未知 |
