...
try {
 ...
 $gradleText = [IO.File]::ReadAllText($gradleFile).Replace('applicationId "com.smartcooking.app"','applicationId "com.smartcooking.app.localtest"').Replace('versionName "1.0"','versionName "1.0-localtest"')
