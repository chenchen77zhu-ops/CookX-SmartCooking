...
<section><h2>添加记录</h2><form @submit.prevent="create"><label>记录类型<select v-model="form.kind"><option value="raw">剩余原料</option><option value="cooked">熟食剩菜</option></select></label>
...
<button class="primary" :disabled="busy||!!pending">保存剩余食材记录</button></form></section>
