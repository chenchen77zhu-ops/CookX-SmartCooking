  ...
  <div class="home-layout">
    <template v-if="!currentView">
      ...
      <main class="dashboard-shell">
        <section class="panel"><div class="panel-heading"><h2>一起做饭</h2><button class="plain-link" @click="router.push('/household')">家庭共享冰箱 →</button></div><p>个人库存保持私有，确认后再与家人分享。</p></section>
