...
const configuredOrigin = import.meta.env.VITE_BACKEND_ORIGIN?.replace(/\/$/, '')
...
export const BACKEND_BASE_URL = savedOrigin || configuredOrigin || (IS_NATIVE_APP ? NATIVE_BACKEND_BASE_URL : '')
